...
public class HangmanWordlist {
    public static Map<String, String> getWordDefinitions() {
        ...
        wordDefinitions.put("apple", "An ... a day keeps the doctor away");
        ...
        wordDefinitions.put("media", "Social ...");
        ...
        wordDefinitions.put("snowman", "Do you want to build a ...?");
        ...
        wordDefinitions.put("galaxy", "Milky Way ...");
        wordDefinitions.put("phone", "The ... works both ways");
        wordDefinitions.put("breeze", "A ... blows through her hair");
        wordDefinitions.put("oasis", "Don't look back in anger - ...");
        wordDefinitions.put("omega", "Alpha or beta? - No, ...");
        wordDefinitions.put("vampires", "Number one enemy of werewolves");
        wordDefinitions.put("puzzling", "The opposite of a piece of cake");
        wordDefinitions.put("gossip", "The ... girls");
        wordDefinitions.put("autoimmune", "A condition where your body attacks yourself");
